...
void CoursesTree::getEmptyCoursesToArray(Array<TripletKey> array,const int elements_to_fill,const int starting_index)
{
    int cnt= elements_to_fill;
    int curr_index=starting_index;
